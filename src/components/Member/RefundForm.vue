<template>
    <div class="col-12 mb-4">
        ...
        <Field name="bankName" rules="required" label="銀行名稱" id="selectBankName" class="form-control" as="select" v-model="formValues.bankName">
    ...
    <div class="col-sm-6 col-12 mb-4">
        ...
        <Field name="branchId" rules="required|max:4|min:4" label="分行代碼" class="form-control" id="inputBranchId" v-model="formValues.branchId">
        </Field>
    ...
    <div class="col-sm-6 col-12 mb-4">
        ...
        <Field name="branchName" rules="required|max:50" label="分行名稱" id="inputBranchName" class="form-control" v-model="formValues.branchName"></Field>
    ...
    <div class="col-12 mb-4">
        ...
        <Field name="bankAccount" rules="required|max:16" label="銀行帳號" id="inputBankAccount" class="form-control" v-model="formValues.bankAccount">
        </Field>
    ...
    <div class="col-12 mb-4">
        ...
        <Field name="accountName" rules="required|max:50" label="戶名" id="inputAccountName" class="form-control" v-model="formValues.accountName"></Field>
